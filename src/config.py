...
class Config:
    ...
    # Trading — all 554 Bybit USDT perpetual symbols
    # Override via SYMBOLS env var: SYMBOLS=BTCUSDT,ETHUSDT,SOLUSDT
    symbols: List[str] = field(default_factory=lambda: [
        "0GUSDT", "1000000BABYDOGEUSDT", "1000000CHEEMSUSDT", "1000000MOGUSDT",
        "10000QUBICUSDT", "10000SATSUSDT", "1000BONKUSDT", "1000BTTUSDT",
        "1000CATUSDT", "1000FLOKIUSDT", "1000LUNCUSDT", "1000NEIROCTOUSDT",
        "1000PEPEUSDT", "1000RATSUSDT", "1000TAGUSDT", "1000TOSHIUSDT",
        "1000TURBOUSDT", "1000XECUSDT", "1000XUSDT", "1INCHUSDT",
        "2ZUSDT", "4USDT", "A2ZUSDT", "AAVEUSDT",
        "ACEUSDT", "ACHUSDT", "ACTUSDT", "ACUUSDT", "ACXUSDT", "ADAUSDT",
        "AERGOUSDT", "AEROUSDT", "AEVOUSDT", "AGIUSDT", "AGLDUSDT", "AINUSDT",
        "AIOUSDT", "AIOZUSDT", "AIXBTUSDT", "AKEUSDT", "AKTUSDT", "ALCHUSDT",
        "ALGOUSDT", "ALICEUSDT", "ALLOUSDT", "ALPINEUSDT", "ALTUSDT", "ALUUSDT",
        "ANIMEUSDT", "ANKRUSDT", "APEUSDT", "APEXUSDT", "API3USDT", "APRUSDT",
        "APTUSDT", "ARBUSDT", "ARCUSDT", "ARIAUSDT", "ARKMUSDT", "ARKUSDT",
        "ARPAUSDT", "ARUSDT", "ASPUSDT", "ASRUSDT", "ASTERUSDT", "ASTRUSDT",
        "ATHUSDT", "ATOMUSDT", "ATUSDT", "AUCTIONUSDT", "AUSDT", "AVAAIUSDT",
        "AVAUSDT", "AVAXUSDT", "AVLUSDT", "AVNTUSDT", "AWEUSDT", "AXLUSDT",
        "AXSUSDT", "B2USDT", "B3USDT", "BABYUSDT", "BANANAS31USDT", "BANANAUSDT",
        "BANDUSDT", "BANKUSDT", "BANUSDT", "BARDUSDT", "BATUSDT", "BBUSDT",
        "BCHUSDT", "BEAMUSDT", "BEATUSDT", "BELUSDT", "BERAUSDT", "BICOUSDT",
        "BIGTIMEUSDT", "BIOUSDT", "BIRBUSDT", "BLASTUSDT", "BLESSUSDT", "BLUAIUSDT",
        "BLURUSDT", "BMTUSDT", "BNBUSDT", "BNTUSDT", "BOBAUSDT", "BOBBOBUSDT",
        "BOMEUSDT", "BRETTUSDT", "BREVUSDT", "BROCCOLIUSDT", "BRUSDT", "BSUUSDT",
        "BSVUSDT", "BTCUSDT", "BTRUSDT", "BUSDT", "C98USDT", "CAKEUSDT",
        "CAMPUSDT", "CARVUSDT", "CATIUSDT", "CCUSDT", "CELOUSDT", "CETUSUSDT",
        "CFXUSDT", "CGPTUSDT", "CHILLGUYUSDT", "CHRUSDT", "CHZUSDT", "CKBUSDT",
        "CLANKERUSDT", "CLOUDUSDT", "CLOUSDT", "COAIUSDT", "COMPUSDT", "COOKIEUSDT",
        "COOKUSDT", "COREUSDT", "COTIUSDT", "COWUSDT", "CROSSUSDT", "CROUSDT",
        "CRVUSDT", "CTCUSDT", "CTKUSDT", "CTSIUSDT", "CUDISUSDT", "CUSDT",
        "CVCUSDT", "CVXUSDT", "CYBERUSDT", "CYSUSDT", "DASHUSDT", "DBRUSDT",
        "DEEPUSDT", "DEGENUSDT", "DEXEUSDT", "DGBUSDT", "DIAUSDT", "DODOUSDT",
        "DOGEUSDT", "DOGUSDT", "DOLOUSDT", "DOODUSDT", "DOTUSDT", "DRIFTUSDT",
        "DUSKUSDT", "DYDXUSDT", "DYMUSDT", "EDENUSDT", "EDUUSDT", "EGLDUSDT",
        "EIGENUSDT", "ELSAUSDT", "ENAUSDT", "ENJUSDT", "ENSOUSDT", "ENSUSDT",
        "EPICUSDT", "ERAUSDT", "ESPORTSUSDT", "ESUSDT", "ETCUSDT", "ETHBTCUSDT",
        "ETHFIUSDT", "ETHUSDT", "EULUSDT", "EVAAUSDT", "FARTCOINUSDT", "FFUSDT",
        "FHEUSDT", "FIDAUSDT", "FIGHTUSDT", "FILUSDT", "FIOUSDT", "FLOCKUSDT",
        "FLOWUSDT", "FLRUSDT", "FLUIDUSDT", "FLUXUSDT", "FOGOUSDT", "FOLKSUSDT",
        "FORMUSDT", "FUSDT", "GALAUSDT", "GASUSDT", "GIGAUSDT", "GIGGLEUSDT",
        "GLMUSDT", "GMTUSDT", "GMXUSDT", "GNOUSDT", "GOATUSDT", "GODSUSDT",
        "GPSUSDT", "GRASSUSDT", "GRIFFAINUSDT", "GRTUSDT", "GUNUSDT", "HAEDALUSDT",
        "HANAUSDT", "HBARUSDT", "HEIUSDT", "HEMIUSDT", "HFTUSDT", "HIGHUSDT",
        "HIPPOUSDT", "HIVEUSDT", "HMSTRUSDT", "HNTUSDT", "HOLOUSDT", "HOMEUSDT",
        "HOOKUSDT", "HPOS10IUSDT", "HUMAUSDT", "HUSDT", "HYPERUSDT", "HYPEUSDT",
        "ICNTUSDT", "ICPUSDT", "ICXUSDT", "IDEXUSDT", "IDUSDT", "ILVUSDT",
        "IMXUSDT", "INITUSDT", "INJUSDT", "INUSDT", "INXUSDT", "IOSTUSDT",
        "IOTAUSDT", "IOTXUSDT", "IOUSDT", "IPUSDT", "IRYSUSDT", "JASMYUSDT",
        "JCTUSDT", "JELLYJELLYUSDT", "JSTUSDT", "JTOUSDT", "JUPUSDT", "KAIAUSDT",
        "KAITOUSDT", "KASUSDT", "KAVAUSDT", "KERNELUSDT", "KGENUSDT", "KITEUSDT",
        "KMNOUSDT", "KNCUSDT", "KSMUSDT", "L3USDT", "LABUSDT", "LAUSDT",
        "LDOUSDT", "LIGHTUSDT", "LINEAUSDT", "LINKUSDT", "LISTAUSDT", "LITUSDT",
        "LPTUSDT", "LQTYUSDT", "LRCUSDT", "LSKUSDT", "LTCUSDT", "LUMIAUSDT",
        "LUNA2USDT", "LYNUSDT", "MAGICUSDT", "MAGMAUSDT", "MANAUSDT", "MANTAUSDT",
        "MASKUSDT", "MAVIAUSDT", "MAVUSDT", "MBOXUSDT", "MELANIAUSDT", "MEMEUSDT",
        "MERLUSDT", "METISUSDT", "METUSDT", "MEUSDT", "MEWUSDT", "MINAUSDT",
        "MIRAUSDT", "MITOUSDT", "MLNUSDT", "MMTUSDT", "MNTUSDT", "MOCAUSDT",
        "MONUSDT", "MOODENGUSDT", "MORPHOUSDT", "MOVEUSDT", "MOVRUSDT", "MTLUSDT",
        "MUBARAKUSDT", "MUSDT", "MYXUSDT", "NAORISUSDT", "NEARUSDT", "NEOUSDT",
        "NEWTUSDT", "NFPUSDT", "NIGHTUSDT", "NILUSDT", "NMRUSDT", "NOMUSDT",
        "NOTUSDT", "NSUSDT", "NTRNUSDT", "NXPCUSDT", "OBTUSDT", "OGNUSDT",
        "OGUSDT", "OKBUSDT", "OLUSDT", "OMUSDT", "ONDOUSDT", "ONEUSDT",
        "ONGUSDT", "ONTUSDT", "OPENUSDT", "OPUSDT", "ORBSUSDT", "ORCAUSDT",
        "ORDERUSDT", "ORDIUSDT", "OXTUSDT", "PARTIUSDT", "PAXGUSDT", "PEAQUSDT",
        "PENDLEUSDT", "PENGUUSDT", "PEOPLEUSDT", "PHAUSDT", "PIEVERSEUSDT",
        "PIPPINUSDT", "PIXELUSDT", "PLAYSOUTUSDT", "PLUMEUSDT", "PNUTUSDT",
        "POLUSDT", "POLYXUSDT", "PONKEUSDT", "POPCATUSDT", "PORTALUSDT",
        "POWERUSDT", "POWRUSDT", "PROMPTUSDT", "PROMUSDT", "PROVEUSDT",
        "PTBUSDT", "PUFFERUSDT", "PUMPBTCUSDT", "PUMPFUNUSDT", "PUNDIXUSDT",
        "PYRUSDT", "PYTHUSDT", "QNTUSDT", "QTUMUSDT", "QUSDT", "RAREUSDT",
        "RAVEUSDT", "RAYDIUMUSDT", "RDNTUSDT", "RECALLUSDT", "REDUSDT",
        "RENDERUSDT", "REQUSDT", "RESOLVUSDT", "REZUSDT", "RIVERUSDT", "RLCUSDT",
        "RLSUSDT", "RLUSDUSDT", "ROAMUSDT", "RONINUSDT", "ROSEUSDT", "RPLUSDT",
        "RSRUSDT", "RUNEUSDT", "RVNUSDT", "SAFEUSDT", "SAGAUSDT", "SAHARAUSDT",
        "SANDUSDT", "SAPIENUSDT", "SAROSUSDT", "SCRTUSDT", "SCRUSDT", "SCUSDT",
        "SDUSDT", "SEIUSDT", "SENTUSDT", "SFPUSDT", "SHELLUSDT", "SHIB1000USDT",
        "SIGNUSDT", "SIRENUSDT", "SKLUSDT", "SKRUSDT", "SKYAIUSDT", "SKYUSDT",
        "SLPUSDT", "SNTUSDT", "SNXUSDT", "SOLAYERUSDT", "SOLUSDT", "SOLVUSDT",
        "SOMIUSDT", "SONICUSDT", "SOONUSDT", "SOPHUSDT", "SOSOUSDT", "SPACEUSDT",
        "SPELLUSDT", "SPKUSDT", "SPORTFUNUSDT", "SPXUSDT", "SQDUSDT", "SSVUSDT",
        "STABLEUSDT", "STBLUSDT", "STEEMUSDT", "STGUSDT", "STORJUSDT", "STOUSDT",
        "STRKUSDT", "STXUSDT", "SUIUSDT", "SUNUSDT", "SUPERUSDT", "SUSDT",
        "SUSHIUSDT", "SWARMSUSDT", "SXPUSDT", "SXTUSDT", "SYNUSDT", "SYRUPUSDT",
        "SYSUSDT", "TACUSDT", "TAIKOUSDT", "TAIUSDT", "TAOUSDT", "TAUSDT",
        "THETAUSDT", "THEUSDT", "TIAUSDT", "TLMUSDT", "TNSRUSDT", "TONUSDT",
        "TOWNSUSDT", "TRBUSDT", "TREEUSDT", "TRIAUSDT", "TRUMPUSDT", "TRUSTUSDT",
        "TRUTHUSDT", "TRUUSDT", "TRXUSDT", "TSTBSCUSDT", "TURTLEUSDT", "TUSDT",
        "TUTUSDT", "TWTUSDT", "UAIUSDT", "UBUSDT", "UMAUSDT", "UNIUSDT",
        "USD1USDT", "USDCUSDT", "USDEUSDT", "USELESSUSDT", "USTCUSDT", "USUALUSDT",
        "USUSDT", "VANAUSDT", "VANRYUSDT", "VELODROMEUSDT", "VELOUSDT", "VELVETUSDT",
        "VETUSDT", "VFYUSDT", "VINEUSDT", "VIRTUALUSDT", "VVVUSDT", "WALUSDT",
        "WAVESUSDT", "WAXPUSDT", "WCTUSDT", "WETUSDT", "WHITEWHALEUSDT", "WIFUSDT",
        "WLDUSDT", "WLFIUSDT", "WOOUSDT", "WUSDT", "XAIUSDT", "XANUSDT",
        "XAUTUSDT", "XCHUSDT", "XCNUSDT", "XDCUSDT", "XIONUSDT", "XLMUSDT",
        "XMRUSDT", "XNYUSDT", "XPINUSDT", "XPLUSDT", "XRPUSDT", "XTZUSDT",
        "XVGUSDT", "XVSUSDT", "YBUSDT", "YFIUSDT", "YGGUSDT", "YZYUSDT",
        "ZAMAUSDT", "ZBCNUSDT", "ZBTUSDT", "ZECUSDT", "ZENUSDT", "ZEREBROUSDT",
        "ZETAUSDT", "ZILUSDT", "ZKCUSDT", "ZKPUSDT", "ZKUSDT", "ZORAUSDT",
        "ZROUSDT", "ZRXUSDT",
    ])
    timeframe: int = 5
